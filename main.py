...
from backtests.SuperTrend.SuperTrendRSIDivergence import SuperTrendRSIDivergence, PandasDataFeed
...
if __name__ == '__main__':
    ...
    for timeframe in timeframes:
        ...
        config_filepath_df = f'btc_{timeframe}_superTrend_RSI_divergence'
        config_filepath_returns = f'SuperTrend_RSI_D_vs_BTC_Benchmark_{timeframe}_returns'
        config_filepath_charts = f'SuperTrend_RSI_D_Visuals_{timeframe}'
        ...
        dataframe = pd.read_csv(
            data_path,
            usecols=['datetime', 'open', 'high', 'low', 'close', 'volume', 'in_uptrend', 'rsi', 'bullish_div',
                     'bearish_div'],
            index_col='datetime',
        ...
        cerebro.addstrategy(SuperTrendRSIDivergence)
